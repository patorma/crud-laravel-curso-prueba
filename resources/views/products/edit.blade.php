                        ...
                        @method('PUT')
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    ...
                                    <input type="text" name="name"  value="{{$product->name}}" placeholder="Ingrese Nombre" class="form-control" id="basiInput">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="basiInput" class="form-label">Precio</label>
                                    <input type="number" name="price" value="{{$product->price}}" placeholder="Ingrese Precio" class="form-control" id="basiInput">
                                </div>
                            </div>
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label for="basiInput" class="form-label">Descripción</label>
                                    <textarea  name="description"  placeholder="Ingrese Descripción" class="form-control" id="basiInput"> {{$product->description}}</textarea>
                                </div>
                            </div>
